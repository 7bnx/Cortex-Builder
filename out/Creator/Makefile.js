...
function Replace(projectType, core, makefileFPU, makefileFLOATABI, cStandard, cppStandard, optimization, defines, includesDir, sources, projectPath = filePath, flagsASM, flagsC, flagsCPP) {
...
DEPS := $(OBJECTS:.o=.d)
-include $(DEPS)
ASMOUTPUTFILE = $(OBJDUMP) -DS -marm $(OUTPUT_PATH)/$(TARGET).elf \\
-Mforce-thumb > $(OUTPUT_PATH)/$(TARGET).s
#-----------------------------------------------------------------------------------------
#	End of Objects list
#-----------------------------------------------------------------------------------------
...
function New(projectPath, controller, flags) {
    ...
    Replace(projectType, controller.core, controller.makefileFPU, controller.makefileFLOATABI, cStandard, cppStandard, optimization, [controller.define], includesDir, [], projectPath);
}
exports.New = New;
