...
export function Replace(projectType:string, core:string, makefileFPU:string, makefileFLOATABI:string,
                        cStandard:string, cppStandard:string, optimization:string, defines:string[],
                        includesDir:string[], sources:string[], projectPath: string = filePath,
                        flagsASM?:string[], flagsC?:string[], flagsCPP?:[]){
...
export function New(projectPath: string, controller: nJsonController.Data, flags?: Flags){
  ...
  Replace(projectType, controller.core, controller.makefileFPU, controller.makefileFLOATABI,
          cStandard, cppStandard, optimization, [controller.define],
          includesDir, [], projectPath);
}
